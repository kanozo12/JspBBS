...
<body>
	...
	<nav class="navbar navbar-default">
		<div class="navbar-header">
			...
			<a href="main.jsp" class="navbar-brand">게시판 웹사이트</a>
		</div>
			...
			<form action="writeAction.jsp" method="post">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					...
					<tbody>
						...
						<tr>
							<td>
								<textarea type="text" class="form-control" placeholder=" 글 내용" name="bbsContent" style="height: 350px;" maxlength="2048"></textarea>
							</td>
						</tr>
					</tbody>
				</table>
